/*
Készítsen programot, amely a main metódus segítségével sorokat olvas be a billentyűzetről 
(tetszőleges  végjelig),  majd  meghatározza  a  sorok  hosszát  (a  sorokban  lévő  karakterek számát),
egy metódus segítségével kiírja a sorokat a sorok hosszával együtt egy random állományba (a metódus 
paraméterei: fájlobjektum, a sort tartalmazó szting és a sorhossz). A fájl tartalmát 
visszafelé olvassa ki és írja azt a képernyőre. 
 */
...
public class RBinárisfájl_billentyűzetről_metódussal {
